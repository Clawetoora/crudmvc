...
<body>
    <div class="container">
        ...
        <nav class="navbar">
            <a class="navbar-brand mb-5 mt-5" href="./index.php">
                <h1>IKEA PREKIŲ VALDYMAS</h1>
            </a>
        </nav>
        <div class="row d-flex justify-content-center">
            <a class="btn-show-form" href ="" >IDĖTI NAUJĄ PREKĘ </a>
        </div>
        <!-- PASLEPTA FORMA -->
       <?php include "./components/formhidden.php"?>
